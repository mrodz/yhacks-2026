 ...
 *
 * CORS: Mobile apps (React Native) don't send an Origin header by default,
 * but we configure permissive CORS for development and web fallback.
 */
@Configuration
@EnableWebSecurity
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.POST, "/users", "/users/confirm", "/auth/login").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
                "http://localhost:5173",
                "https://formfriend.xyz",
                "https://www.formfriend.xyz"
        ));
